import { BadRequestException, Body, Controller, Delete, Get, Inject, Param, ParseIntPipe, Patch, Post, Put, Query, UploadedFile, UseInterceptors } from '@nestjs/common';
...
import DeletePetByIdUseCaseInput from './usecases/dtos/delete.pet.by.id.input';
import DeletePetByIdUseCaseOutput from './usecases/dtos/delete.pet.by.id.output';
